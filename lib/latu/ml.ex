defmodule Latu.ML do
  ...
  **Either spelling.** `Latu.ML.attributes/1` lists snake_case names and the server's allowlist
  ...
  def save(target, path, opts \\ []), do: Persistence.save(target, path, opts)
  ...
  def load(session, name, path, opts \\ []), do: Persistence.load(session, name, path, opts)
